...
const translations = {
  en: {
    ...
    TRANSCRIPTION_SUMMARY: 'Generate transcription summary',
  ...
  es: {
    ...
    TRANSCRIPTION_SUMMARY: 'Generar resumen de transcripción',
  ...
  pt: {
    ...
    BROWSE: 'Procurar',
    LANGUAGE_LABEL: 'Idioma (OPCIONAL)',
    TRANSCRIPTION_SUMMARY: 'Gerar resumo da transcrição',
